...
- This pattern is consistent with a password-guessing or unauthorized access attempt.

### Screenshot 4: Successful Logon Event
- A successful login occurred after several failed attempts.
- This confirms that valid credentials were eventually used.

### Screenshot 5: User Account Creation
- A new local user account was created on the system.
- This could be used as a persistence technique by an attacker.

### Screenshot 6: Privilege Escalation Alert
- Wazuh generated an alert for privilege escalation activity.

### Screenshot 7: Detailed Privilege Escalation Event
- The newly created user was added to the local Administrators group.
- This is considered a high-risk security event.
...
## 7. Impact Assessment
The system was exposed to elevated privileges, which could allow an attacker to gain full administrative control. This may lead to system misuse, data exposure, or further lateral movement within the environment.
